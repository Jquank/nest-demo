...
const config = {
  ...
  "inlineSchema": "// This is your Prisma schema file,\n// learn more about it in the docs: https://pris.ly/d/prisma-schema\n\n// Looking for ways to speed up your queries, or scale easily with your serverless or edge functions?\n// Try Prisma Accelerate: https://pris.ly/cli/accelerate-init\n\ngenerator client {\n  provider = \"prisma-client-js\"\n  output   = \"./client\"\n}\n\ndatasource db {\n  provider = \"mysql\"\n  url      = env(\"DATABASE_URL\")\n}\n\nmodel User {\n  id    Int     @id @default(autoincrement())\n  email String  @unique\n  name  String?\n  age   Int?\n  sex   Int?\n  roles Role[]\n}\n\nmodel LogReq {\n  id        Int      @id @default(autoincrement())\n  code      Int      @default(-1)\n  level     String? // \"INFO\" | \"ERROR\" | etc.\n  method    String?\n  path      String?\n  query     String?\n  body      String?\n  message   String\n  duration  String?\n  status    Int?\n  timestamp DateTime @default(now())\n}\n\nmodel Role {\n  id          Int      @id @default(autoincrement())\n  name        String   @unique\n  desc        String?\n  createTime  DateTime @default(now())\n  users       User[]\n  permissions Json?\n}\n\nmodel Board {\n  id             Int      @id @default(autoincrement())\n  title          String   @unique\n  desc           String?\n  createTime     DateTime @default(now())\n  creator        String?\n  indicatorCount Int?\n  cards          Card[]\n}\n\nmodel Card {\n  id         Int      @id @default(autoincrement())\n  title      String\n  createTime DateTime @default(now())\n  type       String   @default(\"1\") // 图表卡片类型: 1,2,3,4,5,6或者前端自定义组件名\n  posi       Json? // 卡片位置信息\n  config     Json? // 卡片配置信息\n  data       Json? // 卡片数据信息\n  Board      Board?   @relation(fields: [boardId], references: [id])\n  boardId    Int?\n}\n",
  "inlineSchemaHash": "6624c0199cec871055fc03e5b87ab9a9d52156d440517293c9f3352fcda27a4f",
  "copyEngine": true
}
